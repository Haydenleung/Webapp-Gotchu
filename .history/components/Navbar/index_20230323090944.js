        ...
        popup === true ?
          <div className={styles.extendbar}>
            <div className={styles.extendtab}>
              <Image src={'/icons/home.svg'} className={styles.hamburger} width={40} height={40} />
              <h4>Home</h4>
            </div>
            <div className={styles.extendtab}>
              <Image src={'/icons/quiz.svg'} className={styles.hamburger} width={40} height={40} />
              <h4>Quiz</h4>
            </div>
            <div className={styles.extendtab}>
              <Image src={'/icons/result.svg'} className={styles.hamburger} width={40} height={40} />
              <h4>Result</h4>
            </div>
          </div>
          : <></>
