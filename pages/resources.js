        ...
        <div className={styles.main}>
            ...
            <div className={styles.main_container}>
                <div className={styles.pageContent}>
                    <Image src={logo} width={310} height={124} />
                    <section className={styles.externalSupport}>
                        ...
                        <div className={styles.row}>
                            <Image src={'/resources/externalHelp.png'} width={168} height={351} />
                    ...
                    <section className={styles.referenceReading}>
                        ...
                        <div className={styles.row}>
                            ...
                            <Image src={'/resources/referenceReading.png'} width={168} height={351} />
                        </div>
                    </section>
                    <section className={styles.externalQuiz}>
                        ...
                        <div className={styles.row}>
                            <Image src={'/resources/externalQuiz.png'} width={168} height={351} />
                            <div className={styles.buttons}>
